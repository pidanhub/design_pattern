package com.pattern.adapter.customer.objectadapter;
...
public class UserInfoEncoder implements SystemEncoder {
	...
	public String strongerMD5 (String input) {
		for (int i = 0; i < times; i++) {
			input = encoder.THREE_PARTY_MD5(input);
		}
		return input;
	}
	...
	public String strongerBASE64 (String input) {
		for (int i = 0; i < times; i++) {
			input = encoder.THREE_PARTY_BASE64(input);
		}
		return input;
	}
}
